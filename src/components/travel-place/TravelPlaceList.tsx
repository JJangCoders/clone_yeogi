...
import TravelPlaceItem, { TravelPlaceItemProps } from "./TravelPlaceItem";
...
function fetchPlaces(): Promise<TravelPlaceItemProps[]> {
...
export default function TravelPlaceList() {
  const [travelPlaces, setTravelPlaces] = useState<TravelPlaceItemProps[]>([]);
